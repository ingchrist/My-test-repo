...
class UserRegisterForm(forms.ModelForm):
    ...
    username = forms.CharField(max_length=20, label='Profile Username',
                               help_text='Enter a unique username for this user', required=False)
    account_type = forms.ChoiceField(
        choices=Profile.ACCOUNT_TYPES, required=False)
